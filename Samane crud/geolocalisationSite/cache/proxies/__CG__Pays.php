 ...
 */
class Pays extends \Pays implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Pays' . "\0" . 'id', '' . "\0" . 'Pays' . "\0" . 'nom', '' . "\0" . 'Pays' . "\0" . 'longitude', '' . "\0" . 'Pays' . "\0" . 'latitude', '' . "\0" . 'Pays' . "\0" . 'villes'];
        }
